...
public class SystemDefaultCredentialsProvider implements CredentialsProvider {
    ...
    public Credentials getCredentials(final AuthScope authscope) {
        ...
        if (host != null) {
            ...
            if (systemcreds == null) {
                // Look for values given using org.apache.http.proxyUser/org.apache.http.proxyPassword or
                ...
                // still use org.apache.http as protocol
            ...
            if (systemcreds != null) {
                final String domain = System.getProperty("org.apache.http.auth.ntlm.domain");
                if (domain != null) {
