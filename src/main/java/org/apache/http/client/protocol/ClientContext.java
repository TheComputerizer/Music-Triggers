...
public interface ClientContext {
     ...
     * @since 4.3
     */
    public static final String ROUTE   = "org.apache.http.route";

    /**
     * Attribute name of a {@link org.apache.http.conn.scheme.Scheme}
     * object that represents the actual protocol scheme registry.
     */
    public static final String SCHEME_REGISTRY   = "org.apache.http.scheme-registry";
     ...
     */
    public static final String COOKIESPEC_REGISTRY   = "org.apache.http.cookiespec-registry";

    /**
     * Attribute name of a {@link org.apache.http.cookie.CookieSpec}
     * object that represents the actual cookie specification.
     */
    public static final String COOKIE_SPEC           = "org.apache.http.cookie-spec";

    /**
     * Attribute name of a {@link org.apache.http.cookie.CookieOrigin}
     * object that represents the actual details of the origin server.
     */
    public static final String COOKIE_ORIGIN         = "org.apache.http.cookie-origin";

    /**
     * Attribute name of a {@link org.apache.http.client.CookieStore}
     * object that represents the actual cookie store.
     */
    public static final String COOKIE_STORE          = "org.apache.http.cookie-store";

    /**
     * Attribute name of a {@link org.apache.http.client.CredentialsProvider}
     * object that represents the actual credentials provider.
     */
    public static final String CREDS_PROVIDER        = "org.apache.http.auth.credentials-provider";

    /**
     * Attribute name of a {@link org.apache.http.client.AuthCache} object
     * that represents the auth scheme cache.
     */
    public static final String AUTH_CACHE            = "org.apache.http.auth.auth-cache";

    /**
     * Attribute name of a {@link org.apache.http.auth.AuthState}
     * object that represents the actual target authentication state.
     */
    public static final String TARGET_AUTH_STATE     = "org.apache.http.auth.target-scope";

    /**
     * Attribute name of a {@link org.apache.http.auth.AuthState}
     * object that represents the actual proxy authentication state.
     */
    public static final String PROXY_AUTH_STATE      = "org.apache.http.auth.proxy-scope";

    public static final String AUTH_SCHEME_PREF      = "org.apache.http.auth.scheme-pref";
     ...
     */
    public static final String USER_TOKEN            = "org.apache.http.user-token";

    /**
     * Attribute name of a {@link org.apache.http.config.Lookup} object that represents
     * the actual {@link org.apache.http.auth.AuthSchemeRegistry} registry.
     */
    public static final String AUTHSCHEME_REGISTRY   = "org.apache.http.authscheme-registry";

    public static final String SOCKET_FACTORY_REGISTRY = "org.apache.http.socket-factory-registry";
     ...
     * @since 4.3
     */
    public static final String REQUEST_CONFIG = "org.apache.http.request-config";
