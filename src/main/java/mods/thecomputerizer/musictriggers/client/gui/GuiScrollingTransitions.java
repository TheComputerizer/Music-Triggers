...
public class GuiScrollingTransitions extends ObjectSelectionList<GuiScrollingTransitions.Entry> {
    ...
    class Entry extends ObjectSelectionList.Entry<GuiScrollingTransitions.Entry> {
