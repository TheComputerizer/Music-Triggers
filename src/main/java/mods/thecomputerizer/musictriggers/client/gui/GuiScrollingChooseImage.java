...
public class GuiScrollingChooseImage extends ObjectSelectionList<GuiScrollingChooseImage.Entry> {
    ...
    class Entry extends ObjectSelectionList.Entry<GuiScrollingChooseImage.Entry> {
