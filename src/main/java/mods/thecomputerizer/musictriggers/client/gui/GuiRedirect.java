...
public class GuiRedirect extends GuiSuperType {
    ...
    private void toggleViewMode(boolean isActive) {
        ...
        this.viewMode.updateDisplayFormat(isActive ? ChatFormatting.RED : ChatFormatting.WHITE);
    }
        ...
        if(this.viewAll) {
            for (String element : this.allKeys) {
                ...
                if (hover) {
                    ...
                    if(left) GuiUtil.drawBox(new Vector3f(0, top, 0), this.width/2, font.lineHeight + this.spacing * 2,
                            new Vector4f(64, 64, 46, 96), this.getBlitOffset());
                    else GuiUtil.drawBox(new Vector3f(((float)this.width)/2, top, 0), this.width/2, font.lineHeight + this.spacing * 2,
                            new Vector4f(64, 64, 46, 96), this.getBlitOffset());
    ...
    private List<Component> elementHover(String key, boolean left, boolean internal) {
