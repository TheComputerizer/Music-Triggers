...
public class GuiScrollingTransitionsInfo extends ObjectSelectionList<GuiScrollingTransitionsInfo.Entry> {
    ...
    class Entry extends ObjectSelectionList.Entry<GuiScrollingTransitionsInfo.Entry> {
