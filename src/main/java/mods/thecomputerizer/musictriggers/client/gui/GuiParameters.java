...
public class GuiParameters extends GuiSuperType {
    ...
    public static class Parameter {
        ...
        private List<ITextComponent> varNameHover() {
            return Collections.singletonList(new StringTextComponent(this.varName));
        }
        ...
        public List<ITextComponent> drawVariableElement(MatrixStack matrix, Vector2f topLeft, int spacing, int mouseX, int mouseY,
            ...
            if(this.var.getAsBool(true).isPresent()) {
                ...
                if(this.var.getName().matches("channel")) return Collections.singletonList(new StringTextComponent(this.var.get().toString()));
