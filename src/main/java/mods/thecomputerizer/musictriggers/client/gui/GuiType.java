...
public enum GuiType {
    ...
    private final ProgressCreator<Integer, Integer, Float, Integer, TriConsumer<Screen, RadialProgressBar, Vector3f>, RadialProgressBar> progressBar;
    ...
    private final TriConsumer<Screen, RadialProgressBar, Vector3f> progressClick;
