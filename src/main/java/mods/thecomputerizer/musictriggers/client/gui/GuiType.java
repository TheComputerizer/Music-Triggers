...
public enum GuiType {
    ...
    PLAYBACK("playback", MusicTriggers.getIcon("gui/white_icons","playback"), null, Collections.EMPTY_LIST, 100f, 0f,
            ...
            (Screen, bar, mousePos) -> {
                GuiPlayback playback = (GuiPlayback)Screen;
    ...
    private final RadialElement.CreatorFunction<Screen, ResourceLocation, ResourceLocation, RadialProgressBar,
    ...
    GuiType(String id, @Nullable ResourceLocation iconLocation, @Nullable ResourceLocation altIconLocation,
            ...
            ProgressCreator<Integer, Integer, Float, Integer, TriConsumer<Screen, RadialProgressBar, Vector2f>, RadialProgressBar> progressBar,
            @Nullable RadialElement.CreatorFunction<Screen, ResourceLocation, ResourceLocation, RadialProgressBar,
                    Integer, Integer, Integer, Integer, Integer, String, List<String>, Float, Float, ButtonType[],
                    RadialElement> circleConstructor, Integer progressRes, TriConsumer<Screen, RadialProgressBar, Vector2f> progressClick) {
    ...
    GuiType(String id, @Nullable ResourceLocation iconLocation, @Nullable ResourceLocation altIconLocation,
            ...
            @Nullable ProgressCreator<Integer, Integer, Float, Integer, TriConsumer<Screen, RadialProgressBar, Vector2f>, RadialProgressBar> progressBar,
            @Nullable RadialElement.CreatorFunction<Screen, ResourceLocation, ResourceLocation, RadialProgressBar,
                    Integer, Integer, Integer, Integer, Integer, String, List<String>, Float, Float, ButtonType[],
                    RadialElement> circleConstructor, Integer progressRes, TriConsumer<Screen, RadialProgressBar, Vector2f> progressClick) {
        this.id = id;
    ...
    private static RadialElement.CreatorFunction<Screen, ResourceLocation, ResourceLocation, RadialProgressBar,
            Integer, Integer, Integer, Integer, Integer, String, List<String>, Float, Float, ButtonType[],
