...
public class GuiAddSongs extends Screen {
    ...
    public GuiAddSongs(Screen parentScreen, List<String> songs, configObject holder, GuiLinking linking) {
        super(new TranslatableText("screen.musictriggers.add_songs"));
    ...
    public void render(@NotNull MatrixStack matrix, int i, int j, float f) {
        ...
        drawCenteredText(matrix, this.textRenderer, new TranslatableText("screen.musictriggers.text.add_song"), width/2, 8, 10526880);
    }
    ...
    private void addSongs() {
        this.scrollingSongs = new GuiScrollingSong(this.client, this.width, this.height,32,this.height-32, this.songs, null,this, this.holder, this.linking);
