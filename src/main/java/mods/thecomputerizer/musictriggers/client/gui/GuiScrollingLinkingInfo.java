...
public class GuiScrollingLinkingInfo extends ExtendedList<GuiScrollingLinkingInfo.Entry> {
    ...
    class Entry extends ExtendedList.AbstractListEntry<GuiScrollingLinkingInfo.Entry> {
