...
public class Trigger {
        ...
        addTrigger("gui",false,makeParameterSet(true,"resource_name"),
                Arrays.asList("identifier","resource_name"),new ArrayList<>(),(trigger,player) -> {
                    ...
                    return (Objects.nonNull(mc.screen) && (resources.isEmpty() || resources.contains("ANY") ||
                            ...
                            (resources.contains("CREDITS") && mc.screen instanceof WinGameScreen)));
                },true);
        ...
        addTrigger("moon",false, Collections.singletonList("enhancedcelestials"),
                ...
                (trigger,player) -> {
                    ...
                    if(Objects.nonNull(lunarContext) && lunarContext.getCurrentEvent() instanceof Moon)
                        return trigger.checkResourceList(lunarContext.getCurrentEvent().getKey(),trigger.getResource(),false);
                    return false;
                },true);
    ...
    public boolean checkRiding(List<String> resources, ClientPlayerEntity player) {
        ...
        return checkResourceList(ForgeRegistries.ENTITIES.getKey(riding.getType()).toString(),resources,false);
    }
    ...
    public boolean checkForTile(ClientPlayerEntity player) {
        ...
        for(String resource : getResource()) {
            ...
            if(ForgeRegistries.TILE_ENTITIES.containsKey(location)) {
                TileEntityType<?> tileType = ForgeRegistries.TILE_ENTITIES.getValue(location);
