...
public class Channel implements IChannel {
    ...
    private boolean checkAudio() {
        ...
        return settings.getSoundSourceVolume(SoundCategory.MASTER)>0 && settings.getSoundSourceVolume(this.category)>0 &&
    ...
    public void setFadeVolume(float fadeFactor) {
        ...
        GameSettings settings = Minecraft.getInstance().options;
        float categoryVol = settings.getSoundSourceVolume(SoundCategory.MASTER);
        if(this.category!=SoundCategory.MASTER) categoryVol*=settings.getSoundSourceVolume(this.category);
