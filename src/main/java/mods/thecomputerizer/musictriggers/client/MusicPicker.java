...
public class MusicPicker {
    ...
    public Packeted querySongList(Universal universalParameters) {
        ...
        if(player == null) {
            ...
            if (mc.screen!=null && mc.level==null && Objects.nonNull(menu)) {
    ...
    public List<Trigger> playableTriggers(Packeted packet, ClientPlayerEntity player, Universal universalParameters) {
        crashHelper = "";
        try {
