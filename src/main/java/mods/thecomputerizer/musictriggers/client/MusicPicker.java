...
public class MusicPicker {
        ...
        if(Objects.isNull(player)) {
            ...
            if(!activeSongs.isEmpty()) {
                ...
                for(Trigger trigger : this.removePersistentPlayable)
                    if(!this.getInfo().getActiveTriggers().contains(trigger))
    ...
    public static final class Info {
        private final Channel channel;
        private final Set<Audio> currentSongSet;
        private final Set<Audio> previousSongSet;
        private final Set<Trigger> playableTriggers;
        private final Set<Trigger> toggledPlayableTriggers;
        private final Set<Trigger> activeTriggers;
        private final Set<Trigger> toggledActiveTriggers;
