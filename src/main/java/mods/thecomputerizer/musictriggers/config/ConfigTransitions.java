...
public class ConfigTransitions {
    ...
    public final Map<Identifier, ImageDimensions> imageDimensions = new HashMap<>();
        ...
        for (int i : this.imagecards.keySet()) {
            ...
            if(this.ismoving.get(i)) {
                if (this.imagecards.get(i).getName() != null) {
                    String path = "." + "/config/MusicTriggersCommon/songs/assets/musictriggers/textures/" + this.imagecards.get(i).getName();
