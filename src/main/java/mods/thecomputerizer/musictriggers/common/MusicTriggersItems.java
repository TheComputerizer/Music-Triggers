...
public class MusicTriggersItems {
    ...
    public static final RegistryObject<Item> MUSIC_TRIGGERS_RECORD = ITEMS.register("music_triggers_record",
            () -> new MusicTriggersRecord(new Item.Properties().stacksTo(1).tab(ItemGroup.TAB_MISC).rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> CUSTOM_RECORD = ITEMS.register("custom_record",
            () -> new CustomRecord(new Item.Properties().stacksTo(1).tab(ItemGroup.TAB_MISC).rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> BLANK_RECORD = ITEMS.register("blank_record",
            () -> new BlankRecord(new Item.Properties().stacksTo(1).tab(ItemGroup.TAB_MISC).rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> MUSIC_RECORDER = ITEMS.register("music_recorder",
            () -> new BlockItem(MusicTriggersBlocks.MUSIC_RECORDER.get(), new Item.Properties().stacksTo(1).tab(ItemGroup.TAB_MISC).rarity(Rarity.EPIC)));
