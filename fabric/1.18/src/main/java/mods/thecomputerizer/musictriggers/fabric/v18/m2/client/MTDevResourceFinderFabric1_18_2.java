package mods.thecomputerizer.musictriggers.fabric.v18.m2.client;
...
public class MTDevResourceFinderFabric1_18_2 implements RepositorySource {
    
    final File devResources;
    
    public MTDevResourceFinderFabric1_18_2(File file) {
