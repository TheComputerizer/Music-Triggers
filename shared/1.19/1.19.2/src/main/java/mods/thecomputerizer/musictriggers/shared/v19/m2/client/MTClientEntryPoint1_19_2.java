...
public class MTClientEntryPoint1_19_2 extends DelegatingClientEntryPoint {
    
    private static MTClientEntryPoint1_19_2 INSTANCE;
    
    public static MTClientEntryPoint1_19_2 getInstance() {
        return Objects.nonNull(INSTANCE) ? INSTANCE : new MTClientEntryPoint1_19_2();
    }
    
    private MTClientEntryPoint1_19_2() {
        INSTANCE = this;
    }
