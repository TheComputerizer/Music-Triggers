...
public class MTCommonEntryPoint1_21_1 extends DelegatingCommonEntryPoint {
    
    private static MTCommonEntryPoint1_21_1 INSTANCE;
    
    public static MTCommonEntryPoint1_21_1 getInstance() {
        return Objects.nonNull(INSTANCE) ? INSTANCE : new MTCommonEntryPoint1_21_1();
    }
    
    private MTCommonEntryPoint1_21_1() {
        INSTANCE = this;
    }
    ...
    @Override public ClientEntryPoint setDelegatedClientHandle() {
        return MTClientEntryPoint1_21_1.getInstance();
    }
}
