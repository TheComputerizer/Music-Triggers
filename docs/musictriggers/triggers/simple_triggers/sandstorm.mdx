Playable when there is a sandstorm within the specified range.
...
detection_range <default: 16>
    Determines the range around the player that this trigger will check for
    a hurricane in.
