...
Playable when there is a hurricane within the specified range.
Requires [Weather, Storms & Tornadoes](https://www.curseforge.com/minecraft/mc-mods/weather-storms-tornadoes) (1.12.2)

Accepts `active_cooldown`, `detection_range`, `fade_in`, `fade_out`, `max_tracks`, `not`, `passive_persistence`,
