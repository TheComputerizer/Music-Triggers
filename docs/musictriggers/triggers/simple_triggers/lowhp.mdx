...
Accepts `active_cooldown`, `fade_in`, `fade_out`, `level`, `max_health_percentage`, `max_tracks`,
 `min_health_percentage`, `not`, `passive_persistence`, `persistence`, `play_when_paused`, `priority`,
 `start_as_disabled`, `ticks_before_active`, `ticks_before_audio`, `ticks_between_audio`,
...
max_health_percentage <default: 30.0>
    Determines the (exclusive) maximum percentage of the player's health that
    is allowed for this trigger to activate.
...
min_health_percentage <default: 0.0>
    Determines the (exclusive) maximum percentage of the player's health that
    is allowed for this trigger to activate.
