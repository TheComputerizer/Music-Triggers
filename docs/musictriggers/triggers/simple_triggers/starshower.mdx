Playable during a star shower event. Requires [Nyx](https://www.curseforge.com/minecraft/mc-mods/nyx) (1.12.2)

Accepts `active_cooldown`, `fade_in`, `fade_out`, `max_tracks`, `not`, `passive_persistence`, `persistence`,
`play_when_paused`, `priority`, `start_as_disabled`, `ticks_before_active`, `ticks_before_audio`, `ticks_between_audio`,
