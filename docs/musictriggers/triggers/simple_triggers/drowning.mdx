...
Playable when the current air level of the player is below the specified threshold.
...
level <default: 100>
    The maximum air value out of 300 the player is required to be under for
    the trigger to be playable.
