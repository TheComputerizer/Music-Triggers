...
Playable for 1 tick after the command `/musictriggers player commandtrigger identifier` or
`/mt player commandtrigger identifier` with an identifier that matches the set parameter is executed. It is recommended
to use the persistence parameter with this trigger.
