...
Playable when the player attacks another player or is attacked by another player. It is recommended to use the
persistence parameter with this trigger.
