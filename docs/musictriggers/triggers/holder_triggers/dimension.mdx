Playable when the dimension the player is currently in matches the specified parameters.
...
display_name <default: [ any ]>
    The display name of the dimension must match one of the entries here
...
resource_name <default: [ any ]>
    The resource name or ID of the dimension must match one of the entries
