...
Playable during the specified season. Requires
[Serene Seasons](https://www.curseforge.com/minecraft/mc-mods/serene-seasons) (1.12.2, 1.16.5, [1.18.2, 1.19.2] Forge)

Accepts `active_cooldown`, `fade_in`, `fade_out`, `max_tracks`, `not`, `passive_persistence`, `persistence`,
 `play_when_paused`, `priority`, `season`, `start_as_disabled`, `ticks_before_active`, `ticks_before_audio`,
...
season <default: 0>
    Determines the current season that is necessary for this trigger to be
    active.
    0 = Spring
    1 = Summer
    2 = Fall (Autumn)
