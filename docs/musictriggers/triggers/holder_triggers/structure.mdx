...
Playable when the structure at the current position of the player matches the specified parameters.
...
display_name <default: [ any ]>
    The display name of the structure must match one of the entries here
...
resource_name <default: [ any ]>
    The resource name or ID of the structure must match one of the entries
