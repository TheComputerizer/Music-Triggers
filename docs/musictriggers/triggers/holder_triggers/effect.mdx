...
Playable while the player has an active effect which matches the specified parameters.
...
display_name <default: [ any ]>
    The display name of the effect must match one of the entries here
...
resource_name <default: [ any ]>
    The resource name or ID of the effect must match one of the entries
