Playable while a GUI matching the specified parameters is open.
...
display_name <default: [ any ]>
    The display name of the GUI must match one of the entries here
...
resource_name <default: [ any ]>
    The resource name or ID of the GUI must match one of the entries here
