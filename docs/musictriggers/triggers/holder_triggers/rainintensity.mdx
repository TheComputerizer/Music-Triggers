Playable when the intensity level of the rain is at or above the specified level.
Requires [Dynamic Surroundings](https://www.curseforge.com/minecraft/mc-mods/dynamic-surroundings) (1.12.2, 1.16.5)

Accepts `active_cooldown`, `fade_in`, `fade_out`, `level`, `max_tracks`, `not`, `passive_persistence`, `persistence`,
...
level <default: 50>
    The percentage strength of rain required for this trigger to activate.
