...
Accepts `active_cooldown`, `fade_in`, `fade_out`, `items`, `max_tracks`, `not`, `passive_persistence`, `persistence`,
 `play_when_paused`, `priority`, `slots`, `start_as_disabled`, `ticks_before_active`, `ticks_before_audio`,
