Playable when there is a custom moon that matches the specified parameters active.
...
display_name <default: [ any ]>
    The display name of the moon type must match one of the entries here
...
resource_name <default: [ any ]>
    The resource name or ID of the moon type must match one of the entries
