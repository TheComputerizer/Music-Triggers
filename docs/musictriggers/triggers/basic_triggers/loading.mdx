Playable while the game is loading after the client channels have been loaded and before the title screen is shown.
Songs dependent on a redirect entry pointing to an in-game resource will not be able to play until after resources are
loaded.
